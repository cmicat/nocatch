...
public final class NoCatch {
     ...
     * <strong>must</strong> provide a constructor that takes a cause as paramter and it <strong>must</strong> be a
     * static class.
    ...
    private static RuntimeException wrapException(Exception exception,
        Class<? extends RuntimeException> wrapperException) {
        try {
            Constructor<? extends RuntimeException> constructor = wrapperException
